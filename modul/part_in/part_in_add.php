	...
	if(isset($_POST['btnSave'])){	
		...
		if(count($message)==0){			
			...
			if($qrySave){
				...
				mysqli_query($koneksi,"DELETE FROM tr_in_tmp WHERE kode_user='".$_SESSION['kode_user']."'", $koneksi) 
						or die ("Gagal kosongkan tmp".mysqli_error());
					
				$_SESSION['pesan'] = 'Penerimaan barang dengan nomor transaksi '.$kodeBaru.' berhasil dibuat';
				echo '<script>window.location="?page=dtlpartin&id='.base64_encode($kodeBaru).'"</script>';
			}
			else{
...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption"><span class="caption-subject uppercase bold hidden-xs">Form Penerimaan Part MHU</span></div>
		<div class="actions">
