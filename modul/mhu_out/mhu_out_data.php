...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST" class="form-horizontal">
	<div class="portlet box blue">
		...
		<div class="caption"><span class="caption-subject uppercase bold hidden-xs">Data Stok Keluar MHU Box</span></div>
			<div class="actions">
				<a href="?page=addmhuout" class="btn blue"><i class="icon-plus"></i></a>	
