...
<html lang="en">
    ...
    <body class=" login">
        <!-- BEGIN LOGO -->
        <div class="logo">
                <img src="assets/pages/img/logo.png" alt="" width="240px"/>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="login-form" action="masuk.php" method="post">
                <h3 class="form-title font-yellow">Sign In</h3>
                <?php
                ...
                <div class="create-account">
                    <p>
                        <a href="javascript:;" class="uppercase">Forgot Password?</a>
                    </p>
                </div>
        ...
        <div class="copyright"> 2019 © Seventh Media. </div>
        <!--[if lt IE 9]>
