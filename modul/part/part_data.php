...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
	<div class="portlet box blue">
		...
		<div class="caption"><span class="caption-subject uppercase bold">Data Part</span></div>
			<div class="actions">
				<a href="?page=addpart" class="btn blue"><i class="icon-plus"></i></a>	
            ...
            <table class="table table-condensed table-bordered table-hover" id="sample_2">
				...
				<tbody>
                    ...
                    <tr class="odd gradeX">
						...
						<td><a href="?page=edtpart&amp;id=<?php echo base64_encode($Kode); ?>"><?php echo $data['kode_barang']; ?></a></td>
