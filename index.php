                                ...
                                <div class="hor-menu  ">
                                    <ul class="nav navbar-nav">
                                        <li class="menu-dropdown classic-menu-dropdown">
                                            <a href="index.php"><i class="font-blue icon-home"></i> Dashboard</a>
                                        </li>
                                        <li class="menu-dropdown classic-menu-dropdown">
                                            <a href="login.php"><i class="font-blue icon-login"></i> Login</a>
                                        </li>
                                    </ul>
                                </div>
                                <!-- END MEGA MENU -->
            ...
            <div class="page-wrapper-row">
                <div class="page-wrapper-bottom">
                    ...
                    <div class="page-footer">
                        <div class="container"> 2020 &copy; PT Primajasa Tunas Mandiri
                            <a target="_blank" href="http://pdsprima.my.id">Invntory Management System</a> &nbsp;|&nbsp;
                            <a href="" title="" target="_blank">Design By Taufik Akbar</a>
                        </div>
                    </div>
