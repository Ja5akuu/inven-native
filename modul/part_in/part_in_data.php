...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
	<div class="portlet box blue">
		...
		<div class="caption"><span class="caption-subject uppercase bold hidden-xs">Data Stok Masuk Part MHU</span></div>
			<div class="actions">
            ...
            <table class="table table-condensed table-bordered table-hover" id="sample_2">
				...
				<tbody>
                    ...
                    <tr class="odd gradeX">
						...
						<td><div align="center"><a href="?page=dtlpartin&amp;id=<?php echo base64_encode($Kode); ?>" class="btn btn-xs green"><i class="icon-book-open"></i></a></div></td>
                    </tr>
                    <?php } ?>
				</tbody>
            </table>
