	...
	// kode uni merk
	$qry	= mysqli_query($koneksi,"SELECT MAX(kode_merk) as kodeTerbesar FROM ms_merk ");
	...
	if(isset($_POST['btnSave'])){
		...
		if(count($message)==0){			
				// $NewID	= buatKode("ms_merk","kode_merk");	
			$qrySave=mysqli_query($koneksi,"INSERT INTO ms_merk SET kode_merk='$kode', 
				nama_merk='$txtNama',
			...
			<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="frmadd" class="form-horizontal form-bordered" autocomplete='off'>
				<div class="form-body">
					<div class="form-group">
						...
						<div class="col-md-2">
							<input class="form-control" type="text" value="<?php echo $dataKode; ?>"  name="kode_merk" readonly/>
						</div>
					</div>
					<div class="form-group">
