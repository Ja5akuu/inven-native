...
<b style="margin-top:0px; text-decoration:underline">NOTA PENGAMBILAN</b><br>
</div>
 <table style="font-size: 11px">
  <tr>
    <td width="4%">Nomor</td>
    <td width="96%">: <span style="margin-top:0px"><?php echo $beliRow['kode_pengambilan'] ?></span></td>
  </tr>
  <tr>
    <td>Tanggal</td>
    <td>: <span style="margin-top:0px"><?php echo IndonesiaTgl($beliRow['tgl_pengambilan']) ?></span></td>
  </tr>
  <tr>
...
<table width="100%" style="font-size: 11px">
  ...
  <?php
		$listBarangSql = "SELECT 
							...
							WHERE a.kode_pencucian='".$beliRow['kode_pencucian']."'";
...
<table width="100%" border="0" style="font-size: 11px">
  <tr>
    <td><div align="right">Total Tagihan</div></td>
    <td>:</td>
  ...
  <?php 
  		...
  		$qryBayar 		= mysqli_query($koneksi,$sqlBayar);
  ...
  <tr>
    ...
    <td>:</td>
    <td><div align="right"><?php echo format_angka($total-$dataBayar['potongan_pembayaran']); ?></div></td>
  </tr>
  <?php } ?>
</table>
<div style="border-bottom:1px dashed #000;"></div>
