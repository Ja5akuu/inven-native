...
<div class="portlet box blue">
	...
	<div class="caption"><span class="caption-subject uppercase bold hidden-xs">Detail Approval Pengeluaran Barang</span></div>
		<div class="actions">
			<a href="<?php $_SERVER['PHP_SELF']; ?>" class="btn blue"><i class="icon-refresh"></i></a>
			<a href="?page=dtappmdmout" class="btn blue"><i class="icon-close"></i></a>
		</div>
	</div>
	<div class="portlet-body form">
		...
		<div class="form-body">
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="form-group">
						<label>Jenis Pengiriman Lainnya :</label>
			...
			<div class="form-actions">
				...
				<a href="?page=dtappmdmout" class="btn blue"><i class="icon-action-undo"></i> Kembali</a>
			</div>
		</div>
	</form>
  </div>
