...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
	<div class="portlet box blue">
		<div class="portlet-title">
			<div class="caption"><span class="caption-subject uppercase bold hidden-xs">DETAIL APPROVAL PEMASUKAN BARANG</span></div>
			<div class="actions">
				...
				<tbody>
					...
					while ($data = mysqli_fetch_array($dataQry)) {
						...
						<tr class="odd gradeX">
							...
							<td><div align="center"><a href="?page=dtlappmdmin&amp;id=<?php echo base64_encode($Kode); ?>" class="btn btn-xs green"><i class="icon-book-open"></i></a></div></td>
						</tr>
					<?php } ?>
				</tbody>
			</table>
