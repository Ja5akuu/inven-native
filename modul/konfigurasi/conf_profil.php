...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption"><span class="caption-subject uppercase bold hidden-xs">Perubahan Profil</span></div>
		<div class="actions">
	...
	<div class="portlet-body form">			
		<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" name="post" class="form-horizontal form-bordered">
			<div class="form-body">
