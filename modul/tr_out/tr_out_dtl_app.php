...
<div class="portlet box blue">
	...
	<div class="caption"><span class="caption-subject uppercase bold hidden-xs">Detail Approve Pengeluaran Barang</span></div>
		<div class="actions">
			<button type="submit" class="btn blue" name="btnApprove" value="<?php echo $beliRow['kode_out']; ?>"><i class="icon-check"></i></button>
			<a href="<?php $_SERVER['PHP_SELF']; ?>" class="btn blue"><i class="icon-refresh"></i></a>
			<a href="?page=appout" class="btn blue"><i class="icon-close"></i></a>
		</div>
	</div>
