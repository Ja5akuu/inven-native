...
<div class="portlet box blue">
	...
	<div class="caption"><span class="caption-subject uppercase bold hidden-xs">Detail Approval Pengeluaran MHU Box</span></div>
		<div class="actions">
			<a href="<?php $_SERVER['PHP_SELF']; ?>" class="btn blue"><i class="icon-refresh"></i></a>
			<a href="?page=dtappmhuout" class="btn blue"><i class="icon-close"></i></a>
		</div>
	</div>
	<div class="portlet-body form">
		...
		<div class="form-body">
				...
				<div class="col-md-12">
					<table class="table table-hover table-condensed table-striped table-bordered" id="sample_1">
						...
						<?php
								...
								$listBarangQry = mysqli_query($koneksi,$listBarangSql)  or die ("Query list barang salah : ".mysql_error());
			...
			<div class="form-actions">
				...
				<a href="?page=dtappmhuout" class="btn blue"><i class="icon-action-undo"></i> Kembali</a>
			</div>
		</div>
	</form>
  </div>
