...
<h4>SJ<?php echo substr(IndonesiaTgl($tokoRow['tgl_out']),0,2)?>/<?php echo substr(IndonesiaTgl($tokoRow['tgl_out']),3,2)?>/PTM/...../...../<?php echo substr(IndonesiaTgl($tokoRow['tgl_out']),6,4)?></h4>
<br>
