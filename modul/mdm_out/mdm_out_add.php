	...
	if(isset($_POST['btnSave'])){	
		...
		if(count($message)==0){			
			...
			$qrySave		= mysqli_query($koneksi,"INSERT INTO tr_out SET kode_out='$kodeBaru', 
																...
																tgl_kembali='$txtTglPengembalian',
			...
			if($qrySave){
				...
				echo '<script>window.location="?page=dtlmdmout&id='.base64_encode($kodeBaru).'"</script>';
			}
			else{
...
$dataStatusOut		= isset($_POST['cmbStatusOut']) ? $_POST['cmbStatusOut'] : '';
?>
...
<div class="portlet box blue">
	<div class="portlet-title">
		...
		<div class="actions">
			...
			<a href="?page=dtmdmout" class="btn blue"><i class="icon-close"></i></a>
		</div>
	</div>
		...
		<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" class="fieldset-form" autocomplete="off" name="form1" enctype="multipart/form-data">
			<div class="form-body">
					...
					<div class="col-md-3">
						<div class="form-group">
							...
							<select class="form-control select2" data-placeholder="Pilih Lokasi" name="cmbLokasi" onChange="javascript:submitform();">
				                <option value=""></option>
				                <?php
									  $pilihan	= array("Dari Kantor Pusat", 
				...
				<div class="row">
					...
					<div class="col-md-9">
						<div class="form-group">
							<label class="control-label">Alamat Project :</label>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="control-label">Nama PIC Project :</label>
            	...
            	<table class="table table-condensed table-bordered table-hover" width="100%" id="sample_2">
		            ...
		            <tbody>
		                ...
		                $query = mysqli_query($koneksi,"SELECT * FROM ms_barang a
												...
												AND principal_barang='Purchasing'
		                ...
		                while ($data = mysqli_fetch_array($query)) {
		                    ...
		                    <tr class="pilihBarang" data-dismiss="modal" aria-hidden="true" 
								...
								data-nama="<?php echo $data['nama_merk']; ?>"
